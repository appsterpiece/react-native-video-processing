...
- (void)resetSubviews
{
    ...
    CGFloat rightViewFrameX = CGRectGetWidth(self.frameView.frame) < CGRectGetWidth(self.frame) ? (self.maxDuration < CMTimeGetSeconds([self.asset duration]) ? self.maxDuration * self.widthPerSecond + self.thumbWidth : CGRectGetMaxX(self.frameView.frame)): CGRectGetWidth(self.frame) - self.thumbWidth;
